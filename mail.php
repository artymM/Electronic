...
<?php $contacts = R::FindOne('contacts') ?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="container">
			...
			<div class="agile_mail_grids">
				<div class="col-md-5 contact-left">
					<h4>Адрес</h4>
					<p></i>Ул.Садовая 5 ,корпус 3 Москва,Россия.</li></p>
					<ul>
						<li>Телефон :<?php echo $contacts->phone ?></li>
						<li>Факс:<?php echo $contacts->fax ?></li>
						<li><a href="mailto:magazElectro.com"><?php echo $contacts->site ?></a></li>
					</ul>
				</div>
				<div class="col-md-7 contact-left">
					<h4>Форма для отправки</h4>
					<form action="libs/support.php" method="post">
					<div class="form-group row">


   
 
 <input class="form-control" type="text" name="sup_name" placeholder="Имя" required="" id="example-text-input">
  <input class="form-control" type="email" name="sup_email" placeholder="Email" required="" id="example-text-input1">
 <input class="form-control" type="text" name="sup_phone" placeholder="Телефон" required="" id="example-text-input1">
   <div class="form-group" style="
       margin-top: 48px;">
     <textarea class="form-control" name="sup_message" placeholder="Сообщение" required="" id="exampleTextarea" ></textarea>
 </div>
					
						<input type="submit" name="sup_button" value="Отправить" >
					</form>
				</div>
</div> </div>
</div>
