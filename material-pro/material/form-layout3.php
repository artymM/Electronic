                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Форма Добавление контактов</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Форма изменения контактов</h4>
                            </div>
                            <div class="card-body">
                                <form action="../../libs/changes.php" method="POST" class="form-horizontal">
                                    <div class="form-body">
                                        <h3 class="box-title">Изменить контаты</h3>
                                        <hr class="m-t-0 m-b-40">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
												
                                                    <label class="control-label text-right col-md-3"> Телефон</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control"  name="phone" value="<? echo $contdata->phone ?>" placeholder="Телефон">
                                                        <small class="form-control-feedback"> Не более 11 символов</small> </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group  row">
                                                    <label class="control-label text-right col-md-3">Факс</label>
                                                    <div class="col-md-9">
                                                        <input type="text"  name="fax" class="form-control " value="<? echo $contdata->fax ?>" placeholder="Факс">
                                                        <small class="form-control-feedback"> Не более 11 символов </small> </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                  <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Адрес сайта</label>
                                                    <div class="col-md-9">
                                                        <input  type="text"  class="form-control" value="<? echo $contdata->site ?>" name="site" placeholder="Сайт">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
					                                 ...
					                                 <button type="submit" name="change" class="btn btn-success">Изменить</button>    
