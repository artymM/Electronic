            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Аккаунты</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-8 col-md-3 col-sm-6">
                        <div class="card">
							...
							?>
                                            <tr>
												...
												<?php if($ios->stastus=="В Обработке") {?>
                              <form action="../../libs/select.php" method="POST">
									    <td> <select id="country1" name="country1" class="select2" style="width: 100%">
                                    <h5 class="m-t-30">Single select2</h5>
                                     <option value="obr" selected>Обработка</option> 
				        <option value="perd">Предан Курьеру</option>
								...
								<option value="otm">Отменён</option>
												...
												<?php  }?>
																...
																<?php if($ios->stastus=="Передан Курьеру") {?>
                              <form action="../../libs/select.php" method="POST">
									    <td> <select id="country1" name="country1" class="select2" style="width: 100%">
                                    <h5 class="m-t-30">Single select2</h5>
                                     <option value="obr" >Обработка</option> 
				        <option value="perd" selected>Предан Курьеру</option>
								<option value="doc">Доставлен</option>
								<option value="otm">Отменён</option>
				        ...
				        <option value="perd" >Предан Курьеру</option>
								<option value="doc">Доставлен</option>
								<option value="otm" selected>Отменён</option>
                                   
									 </select></td>
												<?php  }?>
												
												
												<?php if($ios->stastus=="Доставлен") {?>
                              <form action="../../libs/select.php" method="POST">
									    <td> <select id="country1" name="country1" class="select2" style="width: 100%">
                                    <h5 class="m-t-30">Single select2</h5>
                                     <option value="obr" >Обработка</option> 
				        <option value="perd" >Предан Курьеру</option>
								<option value="doc" selected>Доставлен</option>
								<option value="otm">Отменён</option>
									 ...
									 <td><button type="submit"  value=<?php echo $ios->id?> name="select"  class="btn btn-success">Изменить</button></form></td>
