                                ...
                                <form action="../../libs/update.php" method="POST" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input  type="password"  class="form-control" name="pass"  placeholder="В целях конфиденциальности пароли были скрыты(md5 шифрование) ">
                                                        <small class="form-control-feedback"> Не более 30 символов </small> </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="switchery-demo m-b-30">
                                          <? if ($del->admin==1){   ?>
                                            <input type="checkbox" uid="<?php echo $del->id; ?>" id="checkbox" checked class="js-switch" data-color="#f62d51" />
                                           <?php } else { ?><input type="checkbox" uid="<?php echo $del->id; ?>" id="checkbox" class="js-switch" data-color="#f62d51" /><?php } ?>
											</div>
											</div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="submit" name="<?php echo $del->id; ?>" id="ord_button" class="btn btn-success">Изменить</button>
...
c.onclick = function() {
 ...
 if (c.checked) {
  alert( 'чекбокс включён' );
    ...
    if ($(this).parent().children('#checkbox').is(':checked')){ var admin = 1 }else{ var admin = 0 }
            var uid = $('#checkbox').attr('uid');
        $.ajax({
            url: '../../libs/updateadmin.php', 
            method: 'post',
            dataType: 'html',
            data:{admin:admin, uid:uid},
        });
});
		});
	 </script>
