					...
					<div class="w3ls_mobiles_grid_left_grid">
						...
						<div class="w3ls_mobiles_grid_left_grid_sub">
							<div class="ecommerce_color">
								<ul>
									<li><a href="products.php?color=Красный"><i></i> Красный(<? echo count($color="Красный")?>)</a></li>
									<li><a href="products.php?color=Серый"><i></i> Серый(<? echo count($color="Серый")?>)</a></li>
									<li><a href="products.php?color=Чёрный"><i></i> Чёрный(3)</a></li>
									<li><a href="products.php?color=Золотой"><i></i> Золотой(3)</a></li>
									<li><a href="products.php?color=Синий"><i></i> Синий(1)</a></li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="w3ls_mobiles_grid_right_grid2">
						...
						<div class="w3ls_mobiles_grid_right_grid2_right">
							<select id="country1" name="country1" class="select_item">
								  ...
								  <option value="nameasc1">Имени (А - Я)</option> 
				        <option value="namedesc1">Имени (Я - А)</option>
								<option value="priceasc1">По цене: по возрастанию</option>
								<option value="pricedesc1">По цене: по убыванию</option>
							</select>
							...
							<div class="agile_ecommerce_tab_left mobiles_grid">
								...
								<div class="simpleCart_shelfItem">
									...
									<form action="cart.php" method="post">
										...
										<button type="submit" name="cart" class="w3ls-cart">В корзину</button>
									</form>
				...
				<section>
					<div class="modal-body">
						...
						<div class="col-md-7 modal_body_right">
							<h4>Новейшие смартоны только у нас </h4>
							<p>Современные смартоны с быстрой памятью и хорошими хорактеристиками толькоунас по супер цене.</p>
							<div class="rating">
							...
							<div class="modal_body_right_cart simpleCart_shelfItem">
								 <i class="item_price">от 17000 руб</i></p>
