                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-4">
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-subtitle m-b-0">check the difference of Admin</h6> </div>
                                </div>
                    ...
                    <div class="col-lg-7 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="download-state chartist-chart" style="height:380px"></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-xlg-3 col-md-6">
                                    <div class="card-body">
                                        ...
                                        <span class="m-t-40 display-6">31560</span>
                                        <h6 class="card-subtitle m-b-30">April the product got 234 reviews</h6>
                                        <a href="javascript:void(0)" class="m-r-10"><img src="../assets/images/users/1.jpg" alt="user" class="img-circle" width="50" /></a>
                                        <a href="javascript:void(0)" class="m-r-10"><img src="../assets/images/users/2.jpg" alt="user" class="img-circle" width="50" /></a>
                                        <a href="javascript:void(0)" class="m-r-10"><img src="../assets/images/users/3.jpg" alt="user" class="img-circle" width="50" /></a>
                                        <a href="javascript:void(0)" class="m-r-10"><img src="../assets/images/users/4.jpg" alt="user" class="img-circle" width="50" /></a>
                                        <div class="clearfix"></div>
                                        <button type="button" class="btn btn-success m-t-40">Read reviews</button>
                                    </div>
                                </div>
                                <!-- Column -->
                                <div class="col-lg-6 col-xlg-9 col-md-6 b-l p-l-0">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="m-piechart" style="width:100%; height:254px"></div>
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card"> <img class="card-img" src="../assets/images/background/socialbg.jpg" alt="Card image">
                            <div class="card-img-overlay card-inverse social-profile d-flex ">
                                <div class="align-self-center"> <img src="../assets/images/users/1.jpg" alt="user" class="img-circle" width="100">
