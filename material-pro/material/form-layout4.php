...
" alt="homepage" class="dark-logo" />
        ...
        <aside class="left-sidebar">
            ...
            <div class="sidebar-footer">
                ...
                <!-- item--><a href="" class="link" data-toggle="tooltip" title="Выход"><i class="mdi mdi-power"></i></a> </div>
            <!-- End Bottom points-->
        </aside>
        <!-- ============================================================== -->
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Форма Добаление Товара</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Форма изменения товара</h4>
                            </div>
                            <div class="card-body">
                                <form action="../../libs/update1.php" method="POST" class="form-horizontal">
                                    <div class="form-body">
                                        <h3 class="box-title">Изменить товар</h3>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="image" value="<?php echo $del->image ?>" placeholder="Картинка">
                                                        <small class="form-control-feedback"> Путь относительно корневого каталога </small> </div>
...
">
												 ...
												 <input type="text" class="form-control"   value="<?php echo $del->image2 ?>" name="image2" placeholder="Картинка">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group  row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text"  name="name" class="form-control " value="<?php echo $del->name ?>" placeholder="Название">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input  type="number"  class="form-control" name="old_price" value="<?php echo $del->old_price ?>" placeholder="Цена">
...
">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input  type="number"  class="form-control" name="price" value="<?php echo $del->price ?>" placeholder="Цена">
                                                        <small class="form-control-feedback"> Не более 20 символов </small> </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group row" style="/* margin-top: 29px; */margin-right: -75px;margin-bottom: 42px;">
                                                    ...
                                                    <div class="col-md-9">
														...
														<?php if ( $del->type=="smart"){ ?>
                                                            <label class="custom-control custom-radio">
															
													
                                                                <input type="radio" name="type" value="smart" checked required  class="custom-control-input">
														 ...
														 <label class="custom-control custom-radio">
                                                            ...
                                                            <label class="custom-control custom-radio">
                                                                <input input type="radio" name="type" value="other" checked required class="custom-control-input">
                                                                <span class="custom-control-indicator"></span>
                                                                <span class="custom-control-description">Товары-2</span>
	     ...
	     <label class="custom-control custom-radio">
                                                            ...
                                                            <label class="custom-control custom-radio">
                                                                ...
                                                                <span class="custom-control-description">Товары-2</span>
															     ...
															     <label class="custom-control custom-radio">
                                                                <input input type="radio" name="type" value="index" checked required class="custom-control-input">
                                                                <span class="custom-control-indicator"></span>
                                                                <span class="custom-control-description">Главная</span>
...
">
				        ...
				        <option value="note" >Ноутбуки</option>
								...
								<option value="pro" >Прочее</option>
                                                ...
                                                <?php } ?> 
												<?php if ($del->prod_cat=="Ноутбуки") { ?>
													    <select id="select" name="select" class="select2" style="width: 100%">
                                    <h5 class="m-t-30">Single select2</h5>
                                     <option value="smart" selected >Смартфоны</option> 
				        <option value="note" selected >Ноутбуки </option>
								<option value="aud">Аудио</option>
								<option value="pro" >Прочее</option>
                                   
									 </select>
                                                <?php } ?> 
												<?php if ($del->prod_cat=="Аудио") { ?>
													    <select id="select" name="select" class="select2" style="width: 100%">
                                    <h5 class="m-t-30">Single select2</h5>
                                     <option value="smart" selected >Смартфоны</option> 
				        <option value="note" >Ноутбуки</option>
								<option value="aud" selected>Аудио</option>
								<option value="pro" >Прочее</option>
                                   
									 </select>
                                                <?php } ?> 
												<?php if ($del->prod_cat=="Прочее") { ?>
													    <select id="select" name="select" class="select2" style="width: 100%">
                                    <h5 class="m-t-30">Single select2</h5>
                                     <option value="smart" selected >Смартфоны</option> 
				        <option value="note" >Ноутбуки</option>
								<option value="aud">Аудио</option>
								<option value="pro"  selected>Прочее</option>
                                   
									 </select>
                                                <?php } ?> 
                                                        <small class="form-control-feedback"> Выбрать категорию товара </small> </div>
                                                </div>
                                            </div>
											   <div class="col-md-6">
                                               <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input  type="text"  class="form-control" name="color" value="<?php echo $del->color ?>" placeholder="Цвет">
                                                        <small class="form-control-feedback"> Не более 30 символов </small> </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                               ...
                                               <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input  type="text"  class="form-control" name="xar1"  value="<?php echo $del->title ?>">
                                                        <small class="form-control-feedback"> Не более 30 символов</small> </div>
                                                </div>
                                            </div>
                                               ...
                                               <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input  type="text"  class="form-control" name="xar2" value="<?php echo $del->title1 ?>">
                                                        <small class="form-control-feedback"> Не более 30 символов </small> </div>
                                                </div>
                                            </div>
											   <div class="col-md-6">
                                               <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input  type="text"  class="form-control" name="xar3" value="<?php echo $del->title2 ?>">
                                                        <small class="form-control-feedback"> Не более 30 символов </small> </div>
                                                </div>
                                            </div>
											   <div class="col-md-6">
                                               <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input  type="text"  class="form-control" name="xar4" value="<?php echo $del->title3 ?>">
                                                        <small class="form-control-feedback"> Не более 30 символов </small> </div>
                                                </div>
                                            </div>
											   <div class="col-md-6">
                                               <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input  type="text"  class="form-control" name="xar5" value="<?php echo $del->title4 ?>">
                                                        <small class="form-control-feedback"> Не более 30 символов </small> </div>
                                                </div>
                                            </div>
											 <div class="col-md-8">
                                     ...
                                     <label class="control-label text-right ">Описание Товара</label>
                                        <textarea class="form-control"  name="about" rows="5"><?php echo $del->about ?></textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="submit" name="<?php echo $del->id ?>" class="btn btn-success">Изменить</button>
