...
" alt="homepage" class="dark-logo" />
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <!-- column -->
                    <div class="col-lg-6 col-md-8 col-md-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Подписки</h4>
                                <h6 class="card-subtitle">Подписки на новости магазина</h6>
