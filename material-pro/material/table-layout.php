            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Таблица Товары</h3>
                        <ol class="breadcrumb">
                                    ...
                                    <table class="table color-table info-table">
										...
										<?php foreach ($tovary as $tovar){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo $tovar->image?></td>
                                                <td><?php echo $tovar->name ?></td>
                                                <td><?php echo $tovar->old_price ?></td>
												 <td><?php echo $tovar->price ?></td>
												 
												 <td> <form action="../../libs/changes.php" method="POST"><button type="submit"  name="<?php echo $tovar->id ?>" class="btn btn-success">Удалить</button></form></td>
												 
												 <form action="form-layout4.php" method="POST">
												 <td><button type="submit"  name="<?php echo $tovar->id?>" class="btn btn-success">Изменить</button></td>
												 </form>
                                            </tr>
