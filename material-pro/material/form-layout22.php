                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-laptop-windows"></i><span class="hide-menu">Template Demos</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="../minisidebar/index.php">Minisidebar</a></li>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Формы</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">Таблицы</span></a>
                            <ul aria-expanded="false" class="collapse">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Форма изменения прав пользователй</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Изменение прав пользователей</h4>
                            </div>
                            <div class="card-body">
                                <form action="../../libs/update.php" method="POST" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <label class="control-label text-right col-md-3"> Имя</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="name" value="<?php echo $del ->name ?>" placeholder="">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group  row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="email"  name="email" class="form-control "  value="<?php echo $del->email?>" placeholder="Email">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                  <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Пароль</label>
                                                    <div class="col-md-9">
                                                        <input  type="password"  class="form-control" name="pass" value="<?php echo $del->pass?>" placeholder="Пароль">
                                                        <small class="form-control-feedback"> This is inline help </small> </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="col-md-6">
                                                  <div class="form-group row">
                                                    <label class="control-label text-right col-md-3">Админ</label>
										<div class="col-md-9">
                                      
                                        <div class="switchery-demo m-b-30">
                                          <? if ($del->admin==1){   ?>
                                            <input type="checkbox" id="checkbox" checked class="js-switch" data-color="#f62d51" />
                                           <?php } else { ?><input type="checkbox" id="checkbox" class="js-switch" data-color="#f62d51" /><?php } ?>
											</div>
											</div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="submit" name="<?php echo $del->id ?>" id="ord_button" class="btn btn-success">Добавить</button>
