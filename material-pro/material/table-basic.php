...
$usert=R::findAll('users', "ORDER BY `id` DESC LIMIT 4");
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <?php foreach($usert as $userts) { ?>
                                            <a href="table-basic.php">
                                                <div class="btn btn-info btn-circle"><i class="ti-plus"></i></div>
                                                <div class="mail-contnet">
                                                    <h5>Добавлен новый пользователь №<?php echo $userts->id ?></h5> <span class="mail-desc"><h6><b><?php echo $userts->name?> </b></h6></div>
                                            </a>
											<?php } ?>
                    ...
                    <div class="col-lg-12 col-md-8 col-md-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Права учётных записей</h6>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $user->pass?></td>
												  <?php if($user->admin==1){?><td><span class="label label-danger">Админ</span> </td>
                                                  <?php } else { ?><td><span class="label label-info">Пользователь</span></td><?php } ?>
												  
												  	<form action="form-layout2.php" method="POST">
												 
												 <td><button type="submit" name="<?php echo  $user->id ?>"  class="btn btn-success">Изменить</button></td>
												  </form>
												
												 <td>  <form action="../../libs/changes3.php" method="POST"><button type="submit"  value=<?php echo  $user->id?> name="u" class="btn btn-success">Удалить</button>	 </form></td>
											
												  	
												 		 <td><form action="table-basic3.php" method="POST"><button type="submit"  value=<?php echo $user->name ?> name="c"  class="btn btn-success">Просмотр</button></form></td>
